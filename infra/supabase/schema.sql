...
-- Backend-only tables: no public Data API policies.
ALTER TABLE public."customer" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."pincode_service" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."product" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."admin_user" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."cms_banner" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."admin_invite" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."shop_setting" ENABLE ROW LEVEL SECURITY;
ALTER TABLE public."postal_area" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE public."mango_season" ENABLE ROW LEVEL SECURITY;
