...
export function Hero({ choose, mangoSeason }: { choose: (category: Category | 'all') => void; mangoSeason: () => void }) {
  ...
  return <><View style={h.hero}>
    ...
    <View style={[h.inner, !wide && { flexDirection: 'column', padding: 18, paddingTop: 24, gap: 0 }]}>
      <Animated.View style={[h.copy, { width: wide ? '52%' : '100%', opacity: reveal, padding: wide ? 28 : 20, gap: wide ? 20 : 16 }]}>
